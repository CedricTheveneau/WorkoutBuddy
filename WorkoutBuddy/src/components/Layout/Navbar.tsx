      ...
      <nav>
        ...
        <div className="navbar">
          <ul className="links">
            ...
            <span className="navbarSeparator">|</span>
            <li>
              <Link to="/WorkoutBuddy/What-is-Workout-Buddy" className="link">
                What is Workout Buddy ?
              </Link>
            </li>
            <span className="navbarSeparator">|</span>
            <li>
              <Link to="/WorkoutBuddy/Who-are-we" className="link">
                Who are we ?
              </Link>
            </li>
            <span className="navbarSeparator">|</span>
            <li>
              <Link to="/WorkoutBuddy/Blog" className="link">
                Blog
              </Link>
            </li>
            <span className="navbarSeparator">|</span>
            <li>
              <Link to="/WorkoutBuddy/Contact" className="link">
                Contact us
              </Link>
            </li>
            <span className="navbarSeparator">|</span>
